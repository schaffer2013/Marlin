 ...
 *
 *  - The simplest option is to use a free endstop connectorX_MAX_PIN.
 ...
 */
//#define Z_MIN_PROBE_PIN X_MAX_PIN // Pin 32 is the RAMPS default
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 100, 0, 0}
